...
#define _convert_uint16_intdec_to_float(integer, decimal) (integer + (float)decimal / BIT_16)
...
#define _convert_uint16_to_float(data) (_get_high_byte_uint(data) + (float)_get_low_byte_uint(data) / BIT_8)
